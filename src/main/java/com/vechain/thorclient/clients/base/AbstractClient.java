...
public abstract class AbstractClient {
     ...
     */
    public static <T> T sendGetRequest(Path path, HashMap<String, String> uriParams, HashMap<String, String> queryParams, Class<T> tClass) {
    ...
    public static <T> T sendPostRequest(Path path, HashMap<String, String> uriParams, HashMap<String, String> queryParams, Object postBody, Class<T> tClass) {
        ...
        if (status != 200) {
            ...
            throw new ClientIOException(exception_msg, status);
        } else {
