...
//              String fieldKeyName = parKeyName(field.getName());
     ...
     * Format the date
     *
     * @param datestr data string like yyyy-MM-dd HH:mm:ss or yyyy-MM-dd
     ...
     * @param methods {@link Method} array.
     * @param fieldSetMet string setter method
