...
;
	...
	public void testDeployContract() throws ClientIOException{
		TransferResult result = TransactionClient.deployContract( contractHexString, 1500000, (byte)0, 720, ECKeyPair.create( privateKey ) );
	...
	public void testGetTransactionReceipt() throws ClientIOException {
		Receipt receipt = TransactionClient
				.getTransactionReceipt(hexId, null);
