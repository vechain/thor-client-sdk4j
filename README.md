...
The maven will generate the jar file in folder target: thor-client-sdk4j-0.0.7.jar
...
java -jar thor-client-sdk4j-0.0.7.jar getChainTag {blockchain-server-url}

eg. java -jar thor-client-sdk4j-0.0.7.jar getChainTag http://localhost:8669
...
```
java -jar thor-client-sdk4j-0.0.7.jar getBlockRef {blockchain-server-url}

eg. java -jar thor-client-sdk4j-0.0.7.jar getBlockRef http://localhost:8669
...
```
 java -jar thor-client-sdk4j-0.0.7.jar getBlock {blockchain-server-url}

eg. java -jar thor-client-sdk4j-0.0.7.jar getBlock http://localhost:8669
...
java -jar thor-client-sdk4j-0.0.7.jar getTransaction {transaction-id} {blockchain-server-url}

eg. java -jar thor-client-sdk4j-0.0.7.jar getTransaction 0x19dd77d28ef70be8c924319a6c08b996dd456fa36f29f2427dbda90087a8a897 http://localhost:8669
...
java -jar thor-client-sdk4j-0.0.7.jar getTransactionReceipt {transaction-id} {blockchain-server-url}
  
eg. java -jar thor-client-sdk4j-0.0.7.jar getTransactionReceipt 0x6b99c0f1ebfa3b9d93dcfc503f468104ac74271728841551aaa44115d080f5b5 http://localhost:8669
...
```
java -jar thor-client-sdk4j-0.0.7.jar sign {your-file-path} {privateKey}

eg. java -jar thor-client-sdk4j-0.0.7.jar sign src/main/resources/exchange_example.xlsx 0xe0b80216ba7b880d85966b38fcd8f7253882bb1386b68b33a8e0b60775e947c0
...
```
java -jar thor-client-sdk4j-0.0.7.jar signVTHO {your-file-path} {privateKey}

eg. java -jar thor-client-sdk4j-0.0.7.jar signVTHO src/main/resources/exchange_example.xlsx 0xdce1443bd2ef0c2631adc1c67e5c93f13dc23a41c18b536effbbdcbcdb96fb65
...
java -jar thor-client-sdk4j-0.0.7.jar signAndSend {blockchain-server-url} {privateKey} {your-file-path}

eg. java -jar thor-client-sdk4j-0.0.7.jar signAndSend http://localhost:8669 0xe0b80216ba7b880d85966b38fcd8f7253882bb1386b68b33a8e0b60775e947c0 src/main/resources/exchange_example.xlsx
...
java -jar thor-client-sdk4j-0.0.7.jar sendRaw {blockchain-server-url} {raw}

eg. java -jar thor-client-sdk4j-0.0.7.jar sendRaw http://localhost:8669 
